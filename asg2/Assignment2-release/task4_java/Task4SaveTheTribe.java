...
public class Task4SaveTheTribe {
  ...
  private Task4Soldier soldier; //modified
  private Spring spring;
  private Task4Monster[] monsters; //modified
  ...
  public Task4SaveTheTribe() {
    ...
    this.soldier = new Task4Soldier(); //modified
    this.spring = new Spring();
    this.monsters = new Task4Monster[7];
    this.gameEnabled = true;
    this.merchant = new Merchant(); //modified
  }
  ...
  public void initialize() {
    ...
    this.monsters[0] = new Task4Monster(1, random.nextInt(5) * 10 + 30);//modified
    this.monsters[0].setPos(4, 1);
    this.monsters[0].addDropItem(2);
    this.monsters[0].addDropItem(3);
 
    this.monsters[1] = new Task4Monster(2, random.nextInt(5) * 10 + 30);//modified
    ...
    this.monsters[6] = new Task4Monster(7, random.nextInt(5) * 10 + 30); //modified
    ...
    this.merchant.setPos(7, 7); //modified
    this.map.addObject(this.merchant); //modified
  }
